...
public class NMPInfo implements org.apache.thrift.TBase<NMPInfo, NMPInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NMPInfo> {
  ...
  static {
    schemes.put(StandardScheme.class, new NMPInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NMPInfoTupleSchemeFactory());
  }

  public String NmMemberType; // required
  public String NmMemberMainVersion; // required
  public String NmMemberPackVersion; // required
  public String IP; // required
  public int Port; // required
  public String NodeName; // required
  public String InstallPath; // required
  public String SchemaInfo_Name; // required
  public String SchemaInfo_User; // required
  public String SchemaInfo_Password; // required
  public String DatabaseType; // required
  public String DatabaseVersion; // required
  public String DbInstallPath; // required
  ...
  public NMPInfo(
    String NmMemberType,
    String NmMemberMainVersion,
    String NmMemberPackVersion,
    String IP,
    int Port,
    String NodeName,
    String InstallPath,
    String SchemaInfo_Name,
    String SchemaInfo_User,
    String SchemaInfo_Password,
    String DatabaseType,
    String DatabaseVersion,
    String DbInstallPath)
  {
    this();
  ...
  public String getNmMemberType() {
    return this.NmMemberType;
  }

  public NMPInfo setNmMemberType(String NmMemberType) {
    this.NmMemberType = NmMemberType;
    return this;
  }
  ...
  public String getNmMemberMainVersion() {
    return this.NmMemberMainVersion;
  }

  public NMPInfo setNmMemberMainVersion(String NmMemberMainVersion) {
    this.NmMemberMainVersion = NmMemberMainVersion;
    return this;
  }
  ...
  public String getNmMemberPackVersion() {
    return this.NmMemberPackVersion;
  }

  public NMPInfo setNmMemberPackVersion(String NmMemberPackVersion) {
    this.NmMemberPackVersion = NmMemberPackVersion;
    return this;
  }
  ...
  public NMPInfo setIP(String IP) {
    this.IP = IP;
    return this;
  }
  ...
  public NMPInfo setNodeName(String NodeName) {
    this.NodeName = NodeName;
    return this;
  }
  ...
  public NMPInfo setInstallPath(String InstallPath) {
    this.InstallPath = InstallPath;
    return this;
  }
  ...
  public String getSchemaInfo_Name() {
    return this.SchemaInfo_Name;
  }

  public NMPInfo setSchemaInfo_Name(String SchemaInfo_Name) {
    this.SchemaInfo_Name = SchemaInfo_Name;
    return this;
  }
  ...
  public String getSchemaInfo_User() {
    return this.SchemaInfo_User;
  }

  public NMPInfo setSchemaInfo_User(String SchemaInfo_User) {
    this.SchemaInfo_User = SchemaInfo_User;
    return this;
  }
  ...
  public String getSchemaInfo_Password() {
    return this.SchemaInfo_Password;
  }

  public NMPInfo setSchemaInfo_Password(String SchemaInfo_Password) {
    this.SchemaInfo_Password = SchemaInfo_Password;
    return this;
  }
  ...
  public NMPInfo setDatabaseType(String DatabaseType) {
    this.DatabaseType = DatabaseType;
    return this;
  }
  ...
  public NMPInfo setDatabaseVersion(String DatabaseVersion) {
    this.DatabaseVersion = DatabaseVersion;
    return this;
  }
  ...
  public NMPInfo setDbInstallPath(String DbInstallPath) {
    this.DbInstallPath = DbInstallPath;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case NM_MEMBER_MAIN_VERSION:
      if (value == null) {
        ...
        setNmMemberMainVersion((String)value);
      }
      break;
    ...
    case NM_MEMBER_PACK_VERSION:
      if (value == null) {
        ...
        setNmMemberPackVersion((String)value);
      }
      break;
    ...
    case SCHEMA_INFO__NAME:
      if (value == null) {
        ...
        setSchemaInfo_Name((String)value);
      }
      break;
    ...
    case SCHEMA_INFO__USER:
      if (value == null) {
        ...
        setSchemaInfo_User((String)value);
      }
      break;
    ...
    case SCHEMA_INFO__PASSWORD:
      if (value == null) {
        ...
        setSchemaInfo_Password((String)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_NmMemberType = true && (isSetNmMemberType());
    list.add(present_NmMemberType);
    if (present_NmMemberType)
      list.add(NmMemberType);

    boolean present_NmMemberMainVersion = true && (isSetNmMemberMainVersion());
    list.add(present_NmMemberMainVersion);
    if (present_NmMemberMainVersion)
      list.add(NmMemberMainVersion);

    boolean present_NmMemberPackVersion = true && (isSetNmMemberPackVersion());
    list.add(present_NmMemberPackVersion);
    if (present_NmMemberPackVersion)
      list.add(NmMemberPackVersion);
    ...
    boolean present_InstallPath = true && (isSetInstallPath());
    list.add(present_InstallPath);
    if (present_InstallPath)
      list.add(InstallPath);

    boolean present_SchemaInfo_Name = true && (isSetSchemaInfo_Name());
    list.add(present_SchemaInfo_Name);
    if (present_SchemaInfo_Name)
      list.add(SchemaInfo_Name);

    boolean present_SchemaInfo_User = true && (isSetSchemaInfo_User());
    list.add(present_SchemaInfo_User);
    if (present_SchemaInfo_User)
      list.add(SchemaInfo_User);

    boolean present_SchemaInfo_Password = true && (isSetSchemaInfo_Password());
    list.add(present_SchemaInfo_Password);
    if (present_SchemaInfo_Password)
      list.add(SchemaInfo_Password);

    boolean present_DatabaseType = true && (isSetDatabaseType());
    list.add(present_DatabaseType);
    if (present_DatabaseType)
      list.add(DatabaseType);

    boolean present_DatabaseVersion = true && (isSetDatabaseVersion());
    list.add(present_DatabaseVersion);
    if (present_DatabaseVersion)
      list.add(DatabaseVersion);

    boolean present_DbInstallPath = true && (isSetDbInstallPath());
    list.add(present_DbInstallPath);
    if (present_DbInstallPath)
      list.add(DbInstallPath);
  ...
  public int compareTo(NMPInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetNmMemberType()).compareTo(other.isSetNmMemberType());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetNmMemberMainVersion()).compareTo(other.isSetNmMemberMainVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetNmMemberPackVersion()).compareTo(other.isSetNmMemberPackVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetInstallPath()).compareTo(other.isSetInstallPath());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInstallPath()) {
    ...
    lastComparison = Boolean.valueOf(isSetSchemaInfo_Name()).compareTo(other.isSetSchemaInfo_Name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSchemaInfo_User()).compareTo(other.isSetSchemaInfo_User());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSchemaInfo_Password()).compareTo(other.isSetSchemaInfo_Password());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetDatabaseType()).compareTo(other.isSetDatabaseType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetDatabaseVersion()).compareTo(other.isSetDatabaseVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetDbInstallPath()).compareTo(other.isSetDbInstallPath());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NMPInfo(");
    boolean first = true;
  ...
  private static class NMPInfoStandardSchemeFactory implements SchemeFactory {
    public NMPInfoStandardScheme getScheme() {
      return new NMPInfoStandardScheme();
    }
  }

  private static class NMPInfoStandardScheme extends StandardScheme<NMPInfo> {
  ...
  private static class NMPInfoTupleSchemeFactory implements SchemeFactory {
    public NMPInfoTupleScheme getScheme() {
      return new NMPInfoTupleScheme();
    }
  }

  private static class NMPInfoTupleScheme extends TupleScheme<NMPInfo> {
