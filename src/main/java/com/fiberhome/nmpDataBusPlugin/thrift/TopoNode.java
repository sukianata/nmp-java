...
public class TopoNode implements org.apache.thrift.TBase<TopoNode, TopoNode._Fields>, java.io.Serializable, Cloneable, Comparable<TopoNode> {
  ...
  static {
    schemes.put(StandardScheme.class, new TopoNodeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TopoNodeTupleSchemeFactory());
  }
  ...
  public void unsetTopoNodeId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TOPONODEID_ISSET_ID);
  }

  /** Returns true if field TopoNodeId is set (has been assigned a value) and false otherwise */
  public boolean isSetTopoNodeId() {
    return EncodingUtils.testBit(__isset_bitfield, __TOPONODEID_ISSET_ID);
  }

  public void setTopoNodeIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TOPONODEID_ISSET_ID, value);
  }
  ...
  public void unsetTopoNodeType() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TOPONODETYPE_ISSET_ID);
  }

  /** Returns true if field TopoNodeType is set (has been assigned a value) and false otherwise */
  public boolean isSetTopoNodeType() {
    return EncodingUtils.testBit(__isset_bitfield, __TOPONODETYPE_ISSET_ID);
  }

  public void setTopoNodeTypeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TOPONODETYPE_ISSET_ID, value);
  }
  ...
  public void unsetLayer3D() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LAYER3D_ISSET_ID);
  }

  /** Returns true if field Layer3D is set (has been assigned a value) and false otherwise */
  public boolean isSetLayer3D() {
    return EncodingUtils.testBit(__isset_bitfield, __LAYER3D_ISSET_ID);
  }

  public void setLayer3DIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LAYER3D_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_TopoNodeId = true;
    list.add(present_TopoNodeId);
    if (present_TopoNodeId)
      list.add(TopoNodeId);
    ...
    boolean present_TopoNodeType = true;
    list.add(present_TopoNodeType);
    if (present_TopoNodeType)
      list.add(TopoNodeType);
    ...
    boolean present_Layer3D = true;
    list.add(present_Layer3D);
    if (present_Layer3D)
      list.add(Layer3D);
  ...
  public int compareTo(TopoNode other) {
    ...
    lastComparison = Boolean.valueOf(isSetTopoNodeId()).compareTo(other.isSetTopoNodeId());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetTopoNodeType()).compareTo(other.isSetTopoNodeType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetLayer3D()).compareTo(other.isSetLayer3D());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLayer3D()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TopoNode(");
    boolean first = true;
  ...
  private static class TopoNodeStandardSchemeFactory implements SchemeFactory {
    public TopoNodeStandardScheme getScheme() {
      return new TopoNodeStandardScheme();
    }
  }

  private static class TopoNodeStandardScheme extends StandardScheme<TopoNode> {
  ...
  private static class TopoNodeTupleSchemeFactory implements SchemeFactory {
    public TopoNodeTupleScheme getScheme() {
      return new TopoNodeTupleScheme();
    }
  }

  private static class TopoNodeTupleScheme extends TupleScheme<TopoNode> {
